...
static int	append_node(t_nodes **first, t_nodes **last, char *word)
{
	t_nodes	*new;
...
static int	split_value_to_nodes(char *value, t_nodes **first)
{
	char	*word;
	t_nodes	*last;
	int		i;
...
static t_nodes	*last_node(t_nodes *first)
{
...
static void	link_replacement(t_nodes **head, t_nodes *node, t_nodes *first)
{
	t_nodes	*prev;
	t_nodes	*next;
	t_nodes	*last;
...
static void	replace_node_with_split(t_nodes **head, t_nodes *node)
{
	t_nodes	*first;
